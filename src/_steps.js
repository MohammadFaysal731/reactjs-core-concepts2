 ...
 * 1. Create a project on <console className="firebase google com".
 * 2. npm install firebase .
 * 3. Register web app in firebase.
 * 4. copy firebase init with config from firebase project settings into a file firebase a file firebase.init.js.
